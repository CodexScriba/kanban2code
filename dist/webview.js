...
`;
  ...
  var toggleControlsBtn = root.querySelector("#toggleControlsBtn");
  var footerControls = root.querySelector("#footerControls");
  if (!textarea || !sendBtn || !captureBtn || !kanbanBtn || !settingsBtn || !chatView || !kanbanView || !chatHistory || !providerSelect || !taskPicker || !taskPickerNotice || !runnerIndicator || !toggleControlsBtn || !footerControls) {
  ...
  var showControls = savedState?.showControls ?? false;
  var knownTasks = [];
