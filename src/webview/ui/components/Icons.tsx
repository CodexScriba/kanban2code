...
export const SettingsIcon: React.FC<IconProps> = ({ className = 'icon', style }) => (
...
export const FolderIcon: React.FC<IconProps> = ({ className = 'icon', style }) => (
  <svg className={className} style={style} viewBox="0 0 16 16" fill="currentColor">
    <path d="M9.828 3h3.982a2 2 0 0 1 1.992 2.181l-.637 7A2 2 0 0 1 13.174 14H2.826a2 2 0 0 1-1.991-1.819l-.637-7a1.99 1.99 0 0 1 .342-1.31L.5 3a2 2 0 0 1 2-2h3.672a2 2 0 0 1 1.414.586l.828.828A2 2 0 0 0 9.828 3zm-8.322.12C1.72 3.042 1.95 3 2.19 3h5.396l-.707-.707A1 1 0 0 0 6.172 2H2.5a1 1 0 0 0-1 .981l.006.139z"/>
  </svg>
);

export const ContextIcon: React.FC<IconProps> = ({ className = 'icon', style }) => (
  <svg className={className} style={style} viewBox="0 0 16 16" fill="currentColor">
...
export const AgentIcon: React.FC<IconProps> = ({ className = 'icon', style }) => (
  <svg className={className} style={style} viewBox="0 0 16 16" fill="currentColor">
...
export const SearchIcon: React.FC<IconProps> = ({ className = 'icon', style }) => (
  <svg className={className} style={style} viewBox="0 0 16 16" fill="currentColor">
    <path d="M11.742 10.344a6.5 6.5 0 1 0-1.397 1.398h-.001c.03.04.062.078.098.115l3.85 3.85a1 1 0 0 0 1.415-1.414l-3.85-3.85a1.007 1.007 0 0 0-.115-.1zM12 6.5a5.5 5.5 0 1 1-11 0 5.5 5.5 0 0 1 11 0z"/>
  </svg>
);

export const ChevronIcon: React.FC<IconProps> = ({ className = 'chevron', style }) => (
  <svg className={className} style={style} viewBox="0 0 16 16" fill="currentColor">
    <path d="M6 12.796V3.204L11.481 8 6 12.796zm.659.753 5.48-4.796a1 1 0 0 0 0-1.506L6.66 2.451C6.011 1.885 5 2.345 5 3.204v9.592a1 1 0 0 0 1.659.753z"/>
  </svg>
);

export const InboxIcon: React.FC<IconProps> = ({ className = 'node-icon', style }) => (
  <svg className={className} style={style} viewBox="0 0 16 16" fill="currentColor">
    <path d="M4.98 4a.5.5 0 0 0-.39.188L1.54 8H6a.5.5 0 0 1 .5.5 1.5 1.5 0 1 0 3 0A.5.5 0 0 1 10 8h4.46l-3.05-3.812A.5.5 0 0 0 11.02 4H4.98zm9.954 5H10.45a2.5 2.5 0 0 1-4.9 0H1.066l.32 2.562a.5.5 0 0 0 .497.438h12.234a.5.5 0 0 0 .496-.438L14.933 9zM3.809 3.563A1.5 1.5 0 0 1 4.981 3h6.038a1.5 1.5 0 0 1 1.172.563l3.7 4.625a.5.5 0 0 1 .105.374l-.39 3.124A1.5 1.5 0 0 1 14.117 13H1.883a1.5 1.5 0 0 1-1.489-1.314l-.39-3.124a.5.5 0 0 1 .106-.374l3.7-4.625z"/>
  </svg>
);

export const PhaseIcon: React.FC<IconProps> = ({ className = 'node-icon', style }) => (
  <svg className={className} style={style} viewBox="0 0 16 16" fill="currentColor">
...
export const EmptyBoardIcon: React.FC<IconProps> = ({ className = 'empty-icon', style }) => (
...
// New icons for FilterBar and other components
export const FilterIcon: React.FC<IconProps> = ({ className = 'icon', style, size = 16 }) => (
...
export const XIcon: React.FC<IconProps> = ({ className = 'icon', style, size = 16 }) => (
  <svg className={className} style={style} width={size} height={size} viewBox="0 0 16 16" fill="currentColor">
    <path d="M2.146 2.854a.5.5 0 1 1 .708-.708L8 7.293l5.146-5.147a.5.5 0 0 1 .708.708L8.707 8l5.147 5.146a.5.5 0 0 1-.708.708L8 8.707l-5.146 5.147a.5.5 0 0 1-.708-.708L7.293 8 2.146 2.854Z"/>
  </svg>
);

export const ChevronDownIcon: React.FC<IconProps> = ({ className = 'icon', style, size = 16 }) => (
  <svg className={className} style={style} width={size} height={size} viewBox="0 0 16 16" fill="currentColor">
    <path fillRule="evenodd" d="M1.646 4.646a.5.5 0 0 1 .708 0L8 10.293l5.646-5.647a.5.5 0 0 1 .708.708l-6 6a.5.5 0 0 1-.708 0l-6-6a.5.5 0 0 1 0-.708z"/>
  </svg>
);

export const OpenFileIcon: React.FC<IconProps> = ({ className = 'icon', style, size = 16 }) => (
  <svg className={className} style={style} width={size} height={size} viewBox="0 0 16 16" fill="currentColor">
...
export const MoreIcon: React.FC<IconProps> = ({ className = 'icon', style, size = 16 }) => (
  <svg className={className} style={style} width={size} height={size} viewBox="0 0 16 16" fill="currentColor">
    <path d="M3 9.5a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3zm5 0a1.5 1.5 0 1 1 0-3 1.5 1.5 0 0 1 0 3z"/>
  </svg>
);

export const ClipboardIcon: React.FC<IconProps> = ({ className = 'icon', style, size = 16 }) => (
  <svg className={className} style={style} width={size} height={size} viewBox="0 0 16 16" fill="currentColor">
...
// Icons namespace for convenient imports
export const Icons = {
